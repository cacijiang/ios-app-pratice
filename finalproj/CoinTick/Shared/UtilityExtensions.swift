...
extension View {
    func addButtonActions(leadingCell: Cell, trailingCell: Cell, id: UUID, onClick: @escaping (Cell, UUID) -> Void) -> some View {
        self.modifier(SwipeContainerCell(leadingCell: leadingCell, trailingCell: trailingCell, id: id,onClick: onClick))
    }
}
